...
#--------------------------------------------
#５．Laravel6.* をcmsディレクトリに設置（インストール） 
#--------------------------------------------
...
#--------------------------------------------
#８．DB起動確認(rootユーザでDB作成)・phpMyAdmin設定
#--------------------------------------------
`mysql -u root -p`
[Enter] ※パスワードなし
`show databases;`
